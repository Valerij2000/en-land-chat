...
SimpleChatbot.prototype._eventHandlerClick = function (e) {
  ...
  var lastDialogQuest = $botWrapper[5];
  if (typeof lastDialogQuest === 'object') {
    Swal.fire({
      title: this._params.name,
      text: 'Congratulations, you got a 50% discount!',
      icon: 'success',
...
SimpleChatbot.resetTemplate = function() {
  ...
  $root.innerHTML = '<div class="chatbot__title"> <img src="img/doctor.jpg" class="ava-header"> Facebook Chat<span class="chatbot__reset"></span></div><div class="chatbot__wrapper"><div class="chatbot__items"><div class="chatbot__ava-content"><img src="img/doctor.jpg" class="ava-header"><h2>DoctorDoc Willie Ong</h2><p>Facebook</p><p>Public figure</p></div></div></div><div class="chatbot__inner-text">Теперь вы можете общаться в Messenger</div><div class="chatbot__footer"><i class="fas fa-plus-circle custom-icon"></i> <i class="fas fa-images custom-icon"></i> <i class="fas fa-thumbs-up custom-icon"></i> <i class="fas fa-smile custom-icon"></i> <input class="chatbot__input" type="text" disabled><button class="chatbot__submit" type="button" disabled></button></div>';
};
